...
const EVALS = evalArg ? Number(evalArg.split('=')[1]) : 240;
...
\`\`\`json
${JSON.stringify({ factorScale: chosen.factorScale, thresholds: weights.thresholds, regimeGate: chosen.regimeGate, mtfWeights: chosen.mtfMult }, null, 2)}
\`\`\`
`;
